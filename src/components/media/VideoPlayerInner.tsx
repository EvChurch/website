...
export default function VideoPlayerInner({ video, onReady }: VideoPlayerInnerProps) {
  ...
  }, [isPlaying, hasSegment, progress, startSec])
  ...
  return (
    <div ref={wrapperRef} className="relative h-full w-full">
      {/* VideoJS container -- override video-js inline-block default to fill the wrapper */}
      <div ref={videoRef} className="h-full w-full [&_.video-js]:!block [&_.video-js]:!h-full [&_.video-js]:!w-full [&_iframe]:!h-full [&_iframe]:!w-full" />
